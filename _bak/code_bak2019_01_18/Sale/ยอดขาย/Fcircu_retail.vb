Public Class Fcircu_retail
    ...
    Private Sub autocal()
        ...
        For i = 0 To DataGridView2.Rows.Count - 1
            tcost += CDbl(DataGridView2.Rows(i).Cells(7).Value)
            tprice += CDbl(DataGridView2.Rows(i).Cells(8).Value)
        Next
    ...
    Private Sub Fcircu_retail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim conn As New OleDb.OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & Application.StartupPath & "\dbsub.accdb")
        conn.Open()

        Dim strselect As String = "select * from T_sale_retail_deteil where s_date = '" & DateTimePicker1.Text & "' ORDER BY ID_sale ASC"
        ...
        With DataGridView2
            If .RowCount > 0 Then
                ...
                .Columns(7).HeaderText = "ราคาทุนรวม"
                .Columns(8).HeaderText = "ราคาขายรวม"
        ...
        Dim strselect1 As String = "select * from T_sale_retail where s_date = '" & DateTimePicker1.Text & "' ORDER BY ID_sale ASC"
        ...
        With DataGridView1
            If .RowCount > 0 Then
                ...
                .Columns(1).HeaderText = "วันที่ขาย"
    ...
    Private Sub DateTimePicker1_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DateTimePicker1.ValueChanged
        ...
        Dim strselect As String = "select * from T_sale_retail_deteil where s_date = '" & DateTimePicker1.Text & "'"
        Dim adp As New OleDb.OleDbDataAdapter(strselect, conn)
        Dim dt As New DataTable
        adp.Fill(dt)
        DataGridView2.DataSource = dt
        ...
        Dim strselect1 As String = "select * from T_sale_retail where s_date = '" & DateTimePicker1.Text & "'"
        Dim adp1 As New OleDb.OleDbDataAdapter(strselect1, conn)
        Dim dt1 As New DataTable
        adp1.Fill(dt1)
        DataGridView1.DataSource = dt1
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If RadioButton1.Checked = True Then
            ...
            e.Graphics.DrawString("รหัสการขาย", Font, Brush, 90, 70)
            e.Graphics.DrawString("วันที่ขาย", Font, Brush, 300, 70)
            e.Graphics.DrawString("ราคาทุน", Font, Brush, 480, 70)
            e.Graphics.DrawString("ยอดขาย", Font, Brush, 660, 70)
            ...
            If DataGridView1.Rows.Count <= 30 Then
                For i = 0 To DataGridView1.Rows.Count - 2
                    e.Graphics.DrawString(DataGridView1.Rows(i).Cells(0).Value, Font, Brush, 90, j)
                    e.Graphics.DrawString(DataGridView1.Rows(i).Cells(1).Value, Font, Brush, 230, j)
                    e.Graphics.DrawString(DataGridView1.Rows(i).Cells(2).Value, Font, Brush, 600, j, Format)
                    e.Graphics.DrawString(DataGridView1.Rows(i).Cells(3).Value, Font, Brush, 785, j, Format)
        ...
        ElseIf RadioButton2.Checked = True Then
            ...
            e.Graphics.DrawString("ชื่อสินค้า", Font, Brush, 240, 70)
            e.Graphics.DrawString("จำนวน", Font, Brush, 390, 70)
            e.Graphics.DrawString("ส่วนลด", Font, Brush, 540, 70)
            e.Graphics.DrawString("ราคาทุนรวม", Font, Brush, 670, 70)
            Dim ii As Integer = 0
            ...
            If DataGridView2.Rows.Count <= 30 Then
                For ii = 0 To DataGridView2.Rows.Count - 2
                    ...
                    e.Graphics.DrawString(DataGridView2.Rows(ii).Cells(4).Value, Font, Brush, 195, jj)
                    e.Graphics.DrawString(DataGridView2.Rows(ii).Cells(5).Value, Font, Brush, 480, jj, Format)
                    e.Graphics.DrawString(DataGridView2.Rows(ii).Cells(7).Value, Font, Brush, 630, jj, Format)
                    e.Graphics.DrawString(DataGridView2.Rows(ii).Cells(8).Value, Font, Brush, 785, jj, Format)
