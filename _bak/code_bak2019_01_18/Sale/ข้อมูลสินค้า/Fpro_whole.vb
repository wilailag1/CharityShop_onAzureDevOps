Public Class Fpro_whole
    Dim ID_pro, p_name, p_price_cost, p_price_sale, p_unit As String
    Dim p_num As Integer

    Private Sub Fpro_whole_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim conn As New OleDb.OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & Application.StartupPath & "\dbsub.accdb")
        conn.Open()

        Dim strshow As String = "select ID_pro, p_name, p_price_cost, p_price_sale,p_unit,p_num from T_pro_whole order by ID_pro asc"
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        ElseIf txtpunit.Text = "" Then
            ...
            txtpunit.Focus()
        Else
            Dim strinsert As String = "update T_pro_whole set p_name = '" & txtpname.Text & "',p_price_cost = '" & txtpprice_cost.Text & "',p_price_sale = '" & txtpprice_sale.Text & "',p_unit = '" & txtpunit.Text & "',p_bal = '" & bsum.ToString("#,###,##0") & "' where ID_pro = '" & txtpid.Text & "'"
            Dim cmd As New OleDb.OleDbCommand(strinsert, conn)
            cmd.ExecuteNonQuery()
            Dim strinsert1 As String = "update T_bar_whole set p_name = '" & txtpname.Text & "',p_price_cost = '" & txtpprice_cost.Text & "',p_price_sale = '" & txtpprice_sale.Text & "',p_unit = '" & txtpunit.Text & "' where ID_pro = '" & txtpid.Text & "'"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If vbyesno = vbYes Then
            Dim strdelete As String = "delete from T_pro_whole where ID_pro = '" & txtpid.Text & "'"
            Dim cmd As New OleDb.OleDbCommand(strdelete, conn)
            cmd.ExecuteNonQuery()
            Dim strdelete1 As String = "delete from T_bar_whole where ID_pro = '" & txtpid.Text & "'"
