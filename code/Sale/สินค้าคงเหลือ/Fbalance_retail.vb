Public Class Fbalance_retail
    ...
    Private Sub txtpsearch_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtpsearch.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Dim strselect As String = "select ID_pro,p_name,p_price_sale,p_num,p_unit from T_pro_retail where ID_pro = '" & txtpsearch.Text & "'"
    ...
    Private Sub Fbalance_retail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim conn As New OleDb.OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & Application.StartupPath & "\dbsub.accdb")
        conn.Open()

        Dim strselect As String = "select ID_pro,p_name,p_price_cost,p_num,p_unit,p_bal from T_pro_retail ORDER BY ID_pro asc"
        Dim adp As New OleDb.OleDbDataAdapter(strselect, conn)
        Dim dt As New DataTable
        adp.Fill(dt)
        DataGridView1.DataSource = dt
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("สินค้าปลีกคงเหลือ", Font2, Brush, 335, 20)
