Public Class Faddpro_whole

    Private Sub Faddpro_whole_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim conn As New OleDb.OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & Application.StartupPath & "\dbsub.accdb")
        conn.Open()

        Dim strshow As String = "select ID_pro,p_name,p_price_cost,p_price_sale,p_unit from T_pro_whole"
    ...
    Private Sub txtpid_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtpid.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Dim strselect As String = "select ID_pro,p_name,p_price_cost,p_price_sale,p_unit from T_pro_whole where ID_pro = '" & txtpid.Text & "'"
