Public Class Faddpro_retail
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ElseIf txtpunit.Text = "" Then
            ...
            txtpunit.Focus()
        Else
            Dim strinsert As String = "insert into T_pro_retail(ID_pro,p_name,p_price_cost,p_price_sale,p_num,p_unit,p_bal,p_type,p_info) 
                                                         values('" & txtpid.Text & "','" & txtpname.Text & "','" & txtpprice_cost.Text & "','" & txtpprice_sale.Text & "','0','" & txtpunit.Text & "','0','" & txtptype.Text & "','" & Combobox_infoPro.Text & "')"
    ...
    Private Sub Combobox_infoPro_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Combobox_infoPro.SelectedIndexChanged
