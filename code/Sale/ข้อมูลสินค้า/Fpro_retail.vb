Public Class Fpro_retail
    ...
    Dim strshow As String = "select ID_pro,p_name,p_type,p_price_cost,p_price_sale,p_num,p_unit,p_info from T_pro_retail "
    Private Sub Fpro_retail_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With DataGridView1
            If .RowCount > 0 Then
                ...
                .Columns(7).HeaderText = "ที่มาสินค้า"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        strshow = strshow + " order by Id_pro asc"
        Dim adp As New OleDb.OleDbDataAdapter(strshow, conn)
        Dim dt As New DataTable
        adp.Fill(dt)
        DataGridView1.DataSource = dt
    ...
    Private Sub txtpsearch_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtpsearch.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            If TxtInFo.Text = "" Then
                'Dim strselect As String = "select ID_pro,p_name,p_price_cost,p_price_sale,p_unit,p_num,p_info from T_pro_retail where p_name LIKE '%" & txtpsearch.Text & "%' order by ID_pro asc"
                Dim strselect As String = strshow + "where p_name LIKE '%" & txtpsearch.Text & "%' order by ID_pro asc"
                ...
                txtpsearch.Clear()
            Else
                Dim strselect As String = "select ID_pro,p_name,p_price_cost,p_price_sale,p_unit,p_num,p_info from T_pro_retail where p_name LIKE '%" & txtpsearch.Text & "%' 
                                            and p_info LIKE'%" & TxtInFo.Text & "%'order by ID_pro asc"
                Dim cmd As New OleDb.OleDbCommand(strselect, conn)
                Dim dr As OleDb.OleDbDataReader = cmd.ExecuteReader
                Dim adp As New OleDb.OleDbDataAdapter(strselect, conn)
                Dim dt As New DataTable
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim countGrid As String
        countGrid = DataGridView1.Rows.Count.ToString()
        If TxtInFo.Text <> "" Then
            e.Graphics.DrawString(DataGridView1.Rows(0).Cells(7).Value.ToString(), Font2, Brush, 450, 20)
        End If
    ...
    Private Sub txtpsearch_TextChanged(sender As Object, e As EventArgs) Handles txtpsearch.TextChanged

    End Sub

    Private Sub Label1_Click(sender As Object, e As EventArgs) Handles Label1.Click, Label11.Click, Label10.Click
    ...
    Private Sub txtptype_TextChanged(sender As Object, e As EventArgs) Handles txtptype.TextChanged
    ...
    Private Sub txtpprice_cost_TextChanged(sender As Object, e As EventArgs) Handles txtpprice_cost.TextChanged
    ...
    Private Sub txtpprice_sale_TextChanged(sender As Object, e As EventArgs) Handles txtpprice_sale.TextChanged
    ...
    Private Sub txtpunit_TextChanged(sender As Object, e As EventArgs) Handles txtpunit.TextChanged

    End Sub

    Private Sub TxtInFo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles TxtInFo.SelectedIndexChanged
